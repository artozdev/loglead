...
export const MESSAGES: Record<string, Entry> = {
  ...
  "dash.viewAllLeads": { en: "View all leads →", fr: "Voir tous les leads →" },
  "dash.noLeads": {
  ...
  "card.reach.label": { en: "LinkedIn Reach", fr: "Portée LinkedIn" },
  "card.reach.unit": { en: "impressions this month", fr: "impressions ce mois" },
  "card.reach.sub": { en: "{views} views · {connections} connections reached", fr: "{views} vues · {connections} connexions touchées" },
  "card.reach.delta": { en: "↑ +{delta}% vs last month", fr: "↑ +{delta}% vs mois dernier" },
