...
function Faq() {
  ...
  const faqs: [string, string][] = [
    [t("What is LogLead?", "Qu'est-ce que LogLead ?"), t("LogLead is an AI prospecting agent for B2B. Describe your ideal client and it finds qualified prospects across LinkedIn, Google Maps, Reddit and the web, enriches their contact details, writes personalized messages, sends them, follows up automatically and surfaces only the hot replies. Your only job is closing the conversations it brings you.", "LogLead est un agent de prospection IA pour le B2B. Décrivez votre client idéal et il trouve des prospects qualifiés sur LinkedIn, Google Maps, Reddit et le web, enrichit leurs coordonnées, rédige des messages personnalisés, les envoie, relance automatiquement et ne remonte que les réponses chaudes. Votre seul travail : closer les conversations qu'il vous amène.")],
