...
function Faq() {
  ...
  const faqs: [string, string][] = [
    [t("What is LogLead exactly?", "Qu'est-ce que LogLead exactement ?"), t("Your AI SDR: describe your ideal client and LogLead searches the web, qualifies and enriches each prospect, then reaches out for you. You focus on closing.", "Votre SDR IA : décrivez votre client idéal et LogLead cherche sur le web, qualifie et enrichit chaque prospect, puis les contacte pour vous. Vous vous concentrez sur le closing.")],
    [t("Where does LogLead search to find prospects?", "Où LogLead cherche-t-il pour trouver des prospects ?"), t("Everywhere your clients are — Google, Google Maps, LinkedIn, Reddit, Instagram, TikTok, Facebook, X and more. One description, every relevant source scanned at once.", "Partout où sont vos clients — Google, Google Maps, LinkedIn, Reddit, Instagram, TikTok, Facebook, X et plus. Une description, toutes les sources pertinentes scannées d'un coup.")],
    [t("What's the difference between LogLead, Apollo and Clay?", "Quelle est la différence entre LogLead, Apollo et Clay ?"), t("Apollo is a fixed database and Clay is a technical tool. LogLead searches 10+ live sources from a plain-language request — including local and your competitors' clients. No setup, results in under 2 minutes.", "Apollo est une base figée et Clay un outil technique. LogLead cherche dans 10+ sources live à partir d'une phrase — y compris en local et chez les clients de vos concurrents. Sans configuration, en moins de 2 minutes.")],
    [t("How quickly will I see results?", "En combien de temps vais-je voir des résultats ?"), t("Under 2 minutes. All sources run at once, then each profile is enriched with email, phone and company data automatically.", "En moins de 2 minutes. Toutes les sources tournent en parallèle, puis chaque profil est enrichi (email, téléphone, données entreprise) automatiquement.")],
    [t("Do I need technical skills to use LogLead?", "Ai-je besoin de compétences techniques pour utiliser LogLead ?"), t("None. Just describe who you're looking for in plain language — no filters, no spreadsheets, no API. If you can type a sentence, you can use LogLead.", "Aucune. Décrivez simplement qui vous cherchez en langage naturel — aucun filtre, aucun tableur, aucune API. Si vous savez taper une phrase, vous savez utiliser LogLead.")],
    [t("Can I cancel anytime?", "Puis-je annuler à tout moment ?"), t("Yes — no commitment. Cancel in one click from Settings → Subscription; your data stays accessible for 30 days after.", "Oui — sans engagement. Annulez en un clic depuis Réglages → Abonnement ; vos données restent accessibles 30 jours après.")],
  ];
