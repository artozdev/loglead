      ...
      <div className="mx-auto flex min-h-full max-w-5xl flex-col items-center px-4 py-10 sm:py-14">
        ...
        <div className="mt-12 grid w-full items-start gap-5 md:grid-cols-3">
          {PLAN_CARDS.map((p) => {
            ...
            const cta = "Commencer gratuitement";
            const inner = (
              <>
        ...
        <p className="mt-8 text-center text-[13px] text-slate-500">
          Essai gratuit · Prix TTC (TVA 20% incluse) · Les entreprises peuvent renseigner leur n° de TVA au paiement · Annulable à tout moment
        </p>
      </div>
    </div>
  );
